...
```bash
pip install jupyterlab_symbol_sidebar
```
...
```bash
pip uninstall jupyterlab_symbol_sidebar
```
...
# Change directory to the jupyterlab_symbol_sidebar directory
...
folder is located. Then you can remove the symlink named `jupyterlab-symbol-sidebar` within that folder.
